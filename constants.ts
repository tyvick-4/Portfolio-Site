        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-lg text-slate-300 leading-relaxed">{caseStudy.overview}</p>
            </section>
            
            {/* Problem Section */}
            <section>
              <h2 className="text-3xl font-bold text-white mb-6">The Problem</h2>
              <p className="text-lg text-slate-300 leading-relaxed">{caseStudy.problem}</p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-4">
                {caseStudy.approach.map((step, index) => (
                  <li key={index} className="text-lg text-slate-300 leading-relaxed flex">
