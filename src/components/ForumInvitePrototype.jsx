...
const SERP_SERVER = {
  slug:        'hollow-reach-community',
  name:        'Hollow Reach Community',
  description: 'The official community for Hollow Reach — survival RPG. Builds, strategy, patch notes, and new player guides.',
  members:     '2,847',
  tags:        'Gaming · Indie RPG',
  threads: [
    {
      title:   'The Riftwalker build is actually broken in 1.4 🔥',
      author:  'grimveil_sk',
...
const SEOLayerOverlay = ({ data, accent }) => (
  <div style={{
    ...
    <div>
      <div style={{
        fontSize: '11px', color: '#80848E', marginBottom: '10px',
        ...
        How this server appears in Google Search
      </div>
      <SerpPreview hasSchema={true} server={SERP_SERVER} />
    </div>
